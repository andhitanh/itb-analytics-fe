    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-4 gap-3">
        <StatCard
          ...
          sub="Rata-rata 12 item"
          valueClassName="text-primary"
        />
        <StatCard
          label="Layanan Perwalian"
          value={PRODI_PERWALIAN_AVG.toFixed(2)}
          sub="Rata-rata P01–P02"
          valueClassName="text-mid"
        />
        <StatCard
          label="Kualitas Perkuliahan"
          value={PRODI_PERKULIAHAN_AVG.toFixed(2)}
          sub="Rata-rata P03–P09"
          valueClassName="text-light"
        />
        <StatCard
          label="Info Lapangan Kerja"
          value={PRODI_LAPKERJA_AVG.toFixed(2)}
          sub="P10 — Prodi jelaskan karir"
      ...
      <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                >
                  {PRODI_ITB_AVG.map((d) => (
                    <Cell
                      key={d.key}
                      fill={GROUP_COLOR[d.group] ?? chartColors.neutral}
                    />
                  ))}
                </Bar>
              </BarChart>
            ...
            <div className="flex gap-3 mt-3 flex-wrap">
              {Object.entries(GROUP_COLOR).map(([g, c]) => (
                <div key={g} className="flex items-center gap-1.5">
                  ...
                  />
                  <span className="text-[11px] text-neutral capitalize">
                    {g}
                  </span>
                </div>
              ))}
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              Rata-Rata Skor Layanan Prodi per{" "}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Distribusi alasan utama per fakultas — 2024-Oktober
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={260}>
            ...
            >
              ...
              />
              <Bar
                dataKey="fasilitasAkademik"
                name="Fasilitas Akademik"
                stackId="a"
                fill={chartColors.mid}
                maxBarSize={16}
              />
              <Bar
                dataKey="suasanaAkademik"
              ...
              />
              <Bar
                dataKey="jejaringAlumni"
                name="Jejaring Alumni"
                stackId="a"
